...
Source0  : https://files.pythonhosted.org/packages/48/c8/6260f8ccc11f0917360fc0da435c5c9c7504e3db174d5a12a1494887b045/attrs-24.3.0.tar.gz
...
%prep
%setup -q -n attrs-24.3.0
cd %{_builddir}/attrs-24.3.0
pushd ..
cp -a attrs-24.3.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1735093588
