...
Source0  : https://files.pythonhosted.org/packages/5a/b0/1367933a8532ee6ff8d63537de4f1177af4bff9f3e829baf7331f595bb24/attrs-25.3.0.tar.gz
...
%prep
%setup -q -n attrs-25.3.0
cd %{_builddir}/attrs-25.3.0
pushd ..
cp -a attrs-25.3.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1742453367
