...
Source0  : https://files.pythonhosted.org/packages/39/31/ca3e2de55503d8ad75985865629f69a2c376a44428c5df1450b749d30751/attrs-24.1.0.tar.gz
...
%prep
%setup -q -n attrs-24.1.0
cd %{_builddir}/attrs-24.1.0
pushd ..
cp -a attrs-24.1.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1722872204
