...
Source0  : https://files.pythonhosted.org/packages/e3/fc/f800d51204003fa8ae392c4e8278f256206e7a919b708eef054f5f4b650d/attrs-23.2.0.tar.gz
...
%prep
%setup -q -n attrs-23.2.0
cd %{_builddir}/attrs-23.2.0
pushd ..
cp -a attrs-23.2.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1707111141
