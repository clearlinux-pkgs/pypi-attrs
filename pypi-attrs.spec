...
Source0  : https://files.pythonhosted.org/packages/fc/0f/aafca9af9315aee06a89ffde799a10a582fe8de76c563ee80bbcdc08b3fb/attrs-24.2.0.tar.gz
...
%prep
%setup -q -n attrs-24.2.0
cd %{_builddir}/attrs-24.2.0
pushd ..
cp -a attrs-24.2.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1722966540
